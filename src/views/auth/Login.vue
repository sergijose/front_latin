                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <InputText id="email1" type="text" placeholder="Email address"
                                class="w-full md:w-[30rem] border border-gray-300 focus:border-primary-500 focus:ring focus:ring-primary-200 rounded-lg shadow-sm"
                        ...
                        <div>
                            ...
                            <Password id="password1" v-model="credenciales.password" placeholder="Password"
                                :toggleMask="true"
                                class="w-full md:w-[30rem] border border-gray-300 focus:border-primary-500 focus:ring focus:ring-primary-200 rounded-lg shadow-sm"
                        ...
                        <div>
                            <Button label="Ingresar"
                                class="w-full mt-4 bg-primary-500 hover:bg-primary-600 text-white font-bold py-2 px-4 rounded-lg shadow-lg"
...
async function ingresar() {
    try {
        ...
        // Limpia errores al iniciar sesión correctamente
        errors.value = {};

        localStorage.setItem("access_token", data.access_token);

        toast.add({ severity: 'success', summary: 'Bienvenido al Sistema', life: 3000 });
        setTimeout(() => {
        ...
        if (error.response && error.response.status === 422) {
            // Asegúrate de asignar los errores exactamente a los campos correspondientes
            ...
            // Error genérico
            errors.value.general = "Ocurrió un error inesperado. Intenta nuevamente.";
        }
    }
}
